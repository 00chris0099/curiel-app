...
export const ModuleFotoPlano = memo(({
    photos,
    busyAction,
    canEdit,
    getEntitySyncState,
        ...
        <div className="space-y-4">
            {mainPhoto ? (
                    ...
                    <div className="flex items-center justify-between p-3">
                        ...
                        {canEdit && (
                            <button
                                ...
                                aria-label="Eliminar foto del plano"
                            >
                ...
                <div className="rounded-2xl border border-dashed border-gray-300 bg-gray-50 p-6 text-center dark:border-gray-600 dark:bg-gray-900/40">
                    <CustomIcon name="ruler" size="md" tone="mist" />
                    <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">No hay foto del plano registrada.</p>
                </div>
            )}
...
ModuleFotoPlano.displayName = 'ModuleFotoPlano';
