...
const EdificioScreen = ({ route, navigation }) => {
    ...
    const loadPhoto = async () => {
        try {
            const existing = await photosRepo.getByType(inspectionId, 'edificio');
    ...
    const savePhoto = async (uri) => {
        ...
        try {
            const data = {
                ...
                inspectionId, type: 'edificio', url: uri, localPath: uri,
    ...
    const deletePhoto = async () => {
        Alert.alert('Eliminar', 'Eliminar foto del edificio?', [
    ...
    return (
        <View style={[styles.container, { backgroundColor: theme.colors.bg }]}>
            <Text style={[styles.title, { color: theme.colors.text }]}>Foto del Edificio</Text>
            {photo ? (
