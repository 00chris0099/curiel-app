            ...
            <View style={[styles.section, { backgroundColor: theme.colors.card }]}>
                <View style={styles.sectionHeader}>
                    ...
                    <TouchableOpacity onPress={() => setShowAddObs(!showAddObs)}>
                        <Text style={[styles.addBtn, { color: theme.colors.primary }]}>+ Agregar</Text>
                    </TouchableOpacity>
                </View>
                ...
                {showAddObs && (
                    <View style={[styles.addForm, { backgroundColor: theme.colors.bg }]}>
                        ...
                        />
                        <TextInput
                            style={[styles.input, styles.textArea, { backgroundColor: theme.colors.card, borderColor: theme.colors.border }]}
                        ...
                        <View style={styles.pickerRow}>
                            ...
                            {['leve', 'media', 'alta', 'critica'].map((s) => (
                                <TouchableOpacity
                                    key={s}
                                    style={[styles.pickerOpt, { backgroundColor: theme.colors.border }, newSeverity === s && styles.pickerOptActive, newSeverity === s && { backgroundColor: theme.colors.primary }]}
                                    onPress={() => setNewSeverity(s)}
                                >
                                    <Text style={[styles.pickerText, { color: theme.colors.text }, newSeverity === s && styles.pickerTextActive]}>{s}</Text>
                                </TouchableOpacity>
                            ))}
                        </View>
                        <View style={styles.pickerRow}>
                            ...
                            {['humedad', 'electrico', 'acabados', 'otro'].map((t) => (
                                <TouchableOpacity
                                    key={t}
                                    style={[styles.pickerOpt, { backgroundColor: theme.colors.border }, newType === t && styles.pickerOptActive, newType === t && { backgroundColor: theme.colors.primary }]}
                                    onPress={() => setNewType(t)}
                                >
                                    <Text style={[styles.pickerText, { color: theme.colors.text }, newType === t && styles.pickerTextActive]}>{t}</Text>
                                </TouchableOpacity>
                            ))}
                        </View>
                        <TouchableOpacity style={[styles.addConfirmBtn, { backgroundColor: theme.colors.primary }]} onPress={addObservation}>
                ...
                {observations.length === 0 ? (
                    ...
                    observations.map((obs) => (
                        <View key={obs.id} style={[styles.obsCard, { backgroundColor: theme.colors.bg }]}>
                            ...
                            <Text style={[styles.obsType, { color: theme.colors.textSecondary }]}>Tipo: {obs.type}</Text>
                            {obs.description ? <Text style={[styles.obsDesc, { color: theme.colors.textSecondary }]}>{obs.description}</Text> : null}
                        </View>
                    ))
                )}
            </View>
