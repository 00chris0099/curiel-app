...
const CreateInspectionScreen = ({ navigation }) => {
    ...
    return (
        <ScrollView style={styles.container} contentContainerStyle={styles.content}>
            ...
            <Text style={styles.label}>Telefono del cliente</Text>
            <TextInput
                style={styles.input}
            ...
            >
                <Text style={form.district ? styles.selectText : styles.selectPlaceholder}>
                            ...
                            >
                                <Text
                                    style={[
                                        ...
                                        form.district === d && styles.pickerItemTextSelected
                                    ]}
                                >
                                    {d}
                                </Text>
                    ...
                    {INSPECTION_TYPES.map((t) => (
                        ...
                        >
                            <Text
                                style={[
                                    styles.pickerItemText,
                                    form.inspectionType === t.value && styles.pickerItemTextSelected
                                ]}
                            >
                                {t.label}
                            </Text>
            ...
            {/* Inspector */}
            <Text style={styles.label}>Inspector asignado *</Text>
            <TouchableOpacity
                style={styles.select}
                onPress={() => setInspectorPickerVisible(!inspectorPickerVisible)}
                disabled={loading}
            >
                <Text style={form.inspectorId ? styles.selectText : styles.selectPlaceholder}>
                        ...
                        {inspectors.map((insp) => (
                            ...
                            >
                                <Text
                                    style={[
                                        styles.pickerItemText,
                                        form.inspectorId === insp.id && styles.pickerItemTextSelected
                                    ]}
                                >
