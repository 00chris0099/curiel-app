    ...
    return (
        <ScrollView style={[styles.container, { backgroundColor: theme.colors.bg }]}>
            ...
            <View style={styles.form}>
                <Text style={[styles.label, { color: theme.colors.text }]}>Titulo *</Text>
                <TextInput
                    style={styles.input}
                ...
                <Text style={[styles.label, { color: theme.colors.text }]}>Severidad</Text>
                ...
                <TouchableOpacity
                    style={[styles.saveBtn, { backgroundColor: theme.colors.success }, saving && styles.disabledBtn]}
                    onPress={save}
                    disabled={saving}
                >
