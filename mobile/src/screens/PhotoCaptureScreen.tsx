    ...
    if (!permission.granted) {
        return (
            <View style={[styles.center, { backgroundColor: theme.colors.bg }]}>
                <Text style={[styles.permText, { color: theme.colors.text }]}>Se necesita permiso de camara</Text>
                <TouchableOpacity style={[styles.permBtn, { backgroundColor: theme.colors.primary }]} onPress={requestPermission}>
                    <Text style={styles.permBtnText}>Conceder Permiso</Text>
                </TouchableOpacity>
                <TouchableOpacity style={[styles.permBtn, { backgroundColor: theme.colors.textSecondary }]} onPress={pickFromGallery}>
        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.previewActions}>
                    ...
                    <TouchableOpacity
                        style={[styles.saveBtn, { backgroundColor: theme.colors.success }, uploading && styles.disabledBtn]}
                        onPress={savePhoto}
                        disabled={uploading}
                    >
                        {uploading ? (
